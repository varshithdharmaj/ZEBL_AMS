...
export const AUDIT_ACTIONS = {
  ...
  SHIFT_ACTIVE_TOGGLED: "shift.active_toggled",
  ...
  RECRUITMENT_JOB_STATUS_CHANGED: "recruitment.job.status_changed",
  RECRUITMENT_JOB_ARCHIVED: "recruitment.job.archived",
  RECRUITMENT_JOB_TEAM_CHANGED: "recruitment.job.team_changed",
  ...
  RECRUITMENT_APPLICATION_CREATED: "recruitment.application.created",
  RECRUITMENT_APPLICATION_ASSESSMENT_UPDATED: "recruitment.application.assessment_updated",
  RECRUITMENT_STAGE_MOVED: "recruitment.pipeline.stage_moved",
  ...
  RECRUITMENT_OFFER_EXPIRED: "recruitment.offer.expired",
  RECRUITMENT_OFFER_REVISION_CREATED: "recruitment.offer.revision_created",
  RECRUITMENT_CANDIDATE_MERGED: "recruitment.candidate.merged",
  RECRUITMENT_CONVERSION_COMPLETED: "recruitment.conversion.completed",
  RECRUITMENT_EMPLOYEE_CREATED: "recruitment.employee.created",
  RECRUITMENT_CLOSED: "recruitment.closed",
  RECRUITMENT_CANDIDATE_CREATED: "recruitment.candidate.created",
  RECRUITMENT_CANDIDATE_UPDATED: "recruitment.candidate.updated",
  RECRUITMENT_CANDIDATE_ARCHIVED: "recruitment.candidate.archived",
  RECRUITMENT_CANDIDATE_RESTORED: "recruitment.candidate.restored",
  RECRUITMENT_CANDIDATE_DUPLICATE_DETECTED: "recruitment.candidate.duplicate_detected",
  RECRUITMENT_CANDIDATE_NOTE_ADDED: "recruitment.candidate.note_added",
  RECRUITMENT_CANDIDATE_DOCUMENT_UPLOADED: "recruitment.candidate.document_uploaded",
  RECRUITMENT_CANDIDATE_DOCUMENT_UPDATED: "recruitment.candidate.document_updated",
  RECRUITMENT_CANDIDATE_DOCUMENT_DELETED: "recruitment.candidate.document_deleted",
  ...
  RECRUITMENT_COMMUNICATION_SCHEDULED: "recruitment.communication.scheduled",
  RECRUITMENT_COMMUNICATION_SCHEDULE_CANCELLED: "recruitment.communication.schedule_cancelled",
